    ...
    <div class="bg-white rounded-lg shadow overflow-hidden mb-6">
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 p-6">
            <div class="flex items-center">
                ...
                @else
                    <div class="h-20 w-20 rounded-full bg-white flex items-center justify-center border-4 border-blue-200">
                        <span class="text-blue-600 font-bold text-3xl">{{ substr($athlete->prenom, 0, 1) }}</span>
                    </div>
                @endif
