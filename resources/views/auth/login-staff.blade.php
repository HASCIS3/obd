<x-guest-layout>
    <div class="text-center mb-4">
        ...
        <h2 class="text-lg font-bold text-gray-800">Espace Administration</h2>
        <p class="text-xs text-gray-500">Connexion réservée aux administrateurs et coachs</p>
    </div>
    ...
    <form method="POST" action="{{ route('login.staff.submit') }}" class="space-y-4">
        @csrf
    ...
    <div class="mt-4 text-center">
        <a href="{{ route('login.select') }}" class="text-xs text-gray-500 hover:text-primary-600">
