...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <h1 class="text-2xl font-bold text-gray-800 mb-2">Suivi Scolaire de {{ $athlete->prenom }}</h1>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="p-4">
                    ...
                    @if($suivi->bulletin_path)
                        <div class="mt-3">
                            <a href="{{ asset('storage/' . $suivi->bulletin_path) }}" target="_blank" class="inline-flex items-center text-green-600 hover:text-green-700 text-sm">
