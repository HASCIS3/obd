        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-1 sm:-my-px sm:ms-6 sm:flex items-center">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" @click.away="open = false" 
                            class="inline-flex items-center px-3 py-2 text-sm font-medium text-white hover:text-secondary-300 hover:bg-primary-600 rounded-md transition {{ request()->routeIs(['performances.*', 'rencontres.*', 'licences.*', 'certificats-medicaux.*']) ? 'bg-primary-600 text-secondary-300' : '' }}">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div x-show="open" x-transition class="absolute left-0 mt-2 w-52 bg-white rounded-md shadow-lg py-1 z-50">
                            ...
                            <a href="{{ route('rencontres.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 {{ request()->routeIs('rencontres.*') ? 'bg-gray-100 text-primary-600' : '' }}">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Suivi Scolaire -->
                    <x-nav-link :href="route('suivis-scolaires.index')" :active="request()->routeIs('suivis-scolaires.*')">
                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
